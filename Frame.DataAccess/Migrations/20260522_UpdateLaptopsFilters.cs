...
{
    /// <inheritdoc />
    public partial class UpdateLaptopsFilters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Delete all old attributes for Laptops category
            migrationBuilder.Sql(@"DELETE FROM Attributes WHERE CategoryId = 2;");

            // Insert new attributes with correct order and bilingual parameters
        ...
        {
            // Delete all attributes for Laptops category if rolling back
            migrationBuilder.Sql(@"DELETE FROM Attributes WHERE CategoryId = 2;");
        }
    }
}
